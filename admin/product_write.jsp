			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<form id="form1" name="form1" method="post" accept-charset="UTF-8"
						action="product_writeProc.jsp" onsubmit="return product_write()">
						<!-- 파일업로드를 위해 추가하는 타입 -->
						...
						<table>
								...
								<td>
									<div class="btn-group btn-group-toggle" data-toggle="buttons">
										<label class="btn btn-secondary active"> <input
											type="radio" name="kind" id="option1" autocomplete="off"
											checked value="cpu"> cpu
										</label> <label class="btn btn-secondary"> <input type="radio"
											name="kind" id="option2" autocomplete="off" value="mainboard">
											mainboard
										</label> <label class="btn btn-secondary"> <input type="radio"
											name="kind" id="option3" autocomplete="off" value="memory">
											memory

										</label> <label class="btn btn-secondary"> <input type="radio"
											name="kind" id="option4" autocomplete="off" value="graphic">
											graphic
										</label> <label class="btn btn-secondary"> <input type="radio"
											name="kind" id="option5" autocomplete="off" value="power">
											power
										</label> <label class="btn btn-secondary"> <input type="radio"
											name="kind" id="option6" autocomplete="off" value="case">
											case

										</label> <label class="btn btn-secondary"> <input type="radio"
											name="kind" id="option7" autocomplete="off" value="cooler">
											cooler
										</label>
									</div>
								</td>
							...
							<tr>
								<td colspan="2" align="center"><input type="submit"
									...
									onclick="location.href='${path}/admin/product.jsp'"> <!-- "목록 버튼을 누르면 list.do페이지로 이동" -->
								</td>
							</tr>
						</table>
					</form>
